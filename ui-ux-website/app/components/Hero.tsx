		...
		<div className="pt-4 lg:pt-10">
			<div className="px-[20px] lg:px-[280px]">
				<h1 className="text-center text-[32px] leading-[40px] font-medium text-[#172026] lg:text-[64px] lg:leading-[72px]">
					Star monitoring your website like a pro
				</h1>
				...
				<div className="flex w-full pt-8 justify-center gap-x-6">
					<button className="bg-[#4328EB] hover:bg-[#3213EF] w-1/2 py-4 px-8 text-white rounded-[4px] lg:w-fit">Try for free</button>
				...
				<div className="absolute bottom-5 flex w-full flex-col items-center">
					...
					<div className="flex w-full flex-col items-center lg:container lg:flex-row lg:justify-between lg:px-20">
						...
						<div className="grid grid-cols-3 items-center justify-center justify-items-center px-[20px] align-middle lg:grid-cols-5">
							...
							<Image src={Cnn} alt="Truspilot" />
							<Image src={Cluth} alt="Truspilot" />
						</div>
					</div>
				</div>
			</div>
